        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Tu pedido llegará en 3-5 días hábiles a tu domicilio o punto de retiro.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿No te quedó bien? No hay problema: cambiamos tu producto por uno nuevo.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Devuelve tu producto y te reembolsamos el dinero, sin complicaciones.
            </p>
          </div>
        </div>
      </div>
